...
const Home = () => {
  return (
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-700 text-white flex flex-row gap-2 pl-4 pt-2'>
        <div className=" max-w-screen-lg  flex flex-col m-auto    justify-center   ">
            <div className="  flex flex-col justify-center h-full">
                <h2 className=' text-4xl md:text-7xl font-bold text-white mt-8'>I'm a full stack developer</h2>
   ...
   <div className='flex justify-center items-center' >
    <img src={pic} className="w-[310px] h-[350px] rounded-2xl mr-4 "  alt="profile" />
   </div>
